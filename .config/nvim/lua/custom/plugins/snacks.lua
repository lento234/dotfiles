return {
  ...
  keys = {
    ...
    { "<leader>glg", function() Snacks.lazygit.log() end,             desc = "[g]it: [l]azygit [l]og [g]raph" },
    { "<leader>gll", function() Snacks.picker.git_log_line() end,     desc = "[g]it: [l]og [l]ine" },
    ...
    { "<leader>ms",  function() Snacks.picker.marks() end,            desc = "[m]arks: [s]how" },
  },
  config = function()
